...
export default function App() {
  ...
  return (
    <TelemetryProvider>
      <div className="h-screen overflow-hidden bg-[#F5F6F8] text-neutral-900 dark:bg-[#0A0A0A] dark:text-neutral-100 flex flex-col font-sans select-none selection:bg-[#C7F000]/30 selection:text-neutral-900">
        {/* Sticky Top Header */}
        <Header />

        {/* Master Content Viewport */}
        ...
        <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 bg-white/80 border border-neutral-200/70 backdrop-blur-md dark:bg-neutral-900/90 dark:border-neutral-800 px-3 py-2.5 rounded-2xl shadow-xl flex items-center gap-1.5 z-50 select-none max-w-[90vw]">
          <button
          ...
          <div className="w-px h-5 bg-neutral-300 dark:bg-neutral-800 mx-1 hidden sm:block" />
